    ...
    <div className="min-h-screen bg-[#FDF8EE] text-slate-900 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-12 flex flex-col items-center justify-center">
        <div className="bg-white border-3 border-slate-950 rounded-3xl p-8 sm:p-12 shadow-[8px_8px_0px_0px_#020617] max-w-2xl w-full text-center relative overflow-hidden">
          {/* Top Banner Tag */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#FFEAEF] text-[#FF6B8B] rounded-full border-2 border-slate-950 text-xs font-display font-black shadow-[2px_2px_0px_0px_#020617] mb-6">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Under Construction</span>
          </div>

          {/* Epic Center Icon */}
          <div className="w-24 h-24 mx-auto rounded-3xl bg-[#E8FAF5] border-3 border-slate-950 flex items-center justify-center text-5xl shadow-[4px_4px_0px_0px_#020617] mb-6">
            🏰
          </div>
          ...
          <p className="text-sm font-bold text-slate-600 mt-4 max-w-md mx-auto leading-relaxed">
            The kingdom's architects are forging the tavern! Soon you will team up with fellow adventurers, participate in cooperative boss raids, and compete on global leaderboards.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-8 text-left">
            <div className="p-3.5 rounded-2xl border-2 border-slate-950 bg-[#FDF8EE] shadow-[2px_2px_0px_0px_#020617]">
              ...
              <div className="font-display font-black text-xs text-slate-900">Guild Parties</div>
              <div className="text-[11px] font-bold text-slate-500 mt-0.5">
                Join forces with friends on shared accountability quests.
              </div>
            </div>

            <div className="p-3.5 rounded-2xl border-2 border-slate-950 bg-[#FDF8EE] shadow-[2px_2px_0px_0px_#020617]">
              <div className="text-xl mb-1">🏆</div>
              <div className="font-display font-black text-xs text-slate-900">Leaderboards</div>
              <div className="text-[11px] font-bold text-slate-500 mt-0.5">
                Climb local and realm-wide rankings in XP and Streaks.
              </div>
            </div>

            <div className="p-3.5 rounded-2xl border-2 border-slate-950 bg-[#FDF8EE] shadow-[2px_2px_0px_0px_#020617]">
              <div className="text-xl mb-1">💬</div>
              <div className="font-display font-black text-xs text-slate-900">Tavern Chat</div>
              <div className="text-[11px] font-bold text-slate-500 mt-0.5">
                Exchange tips, lore, and celebrate epic daily victories.
              </div>
            </div>
          </div>
